...
<?php require_once "bootstrap1.php";?><?php require_once "bootstrap.php"; ?>
...
<div class="login">
	<form name="form1" action="signup.php" method="POST" onsubmit="return checkForm(this);">
		<div class="head">
			<h1><b>Sign Up</b></h1>
		</div>
		<div class="bd1">
...
echo	'<p class="new">
		"Already have an account"<br>
		 <a data-ga-click="Sign in, switch to sign in" href="signinpage.php?type='.$_REQUEST['type'].'" style="color: white;">Sign In</a>
  </p>';
  ?>
