			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="2000">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img src="img/slide1.jpg" alt="Chicago" style="width:100%; height: 500px; transition-duration: 2s;">
					...
					<div class="item">
						<img src="img/slide2.jpg" alt="Chicago" style="width:100%; height: 500px; transition-duration: 2s;">
						
					</div>

					<div class="item">
						<img src="img/slide3.jpg" alt="Chicago" style="width:100%; height: 500px; transition-duration: 2s;">
						
					</div>

					<div class="item">
						<img src="img/slide4.jpg" alt="Los Angeles" style="width:100%; height: 500px; transition-delay: 1s;">
		...
		if (isset($_SESSION['mail'])) {
			if ($_SESSION['type'] == 'admin') {
				...
				echo '<div style="margin-left:40%" >
				 ...
				 <h3> CLICK UPLOAD  </h3>
				<button type="button" style=" margin:10px; hieght:150px; width:150px; background-color:transparent; " data-toggle="modal" data-target="#myModal" style="background-color: transparent; height: 225px; width: 300px; text-align: center;">
				<img src="images/a2.png" class="center">
			  </button>
			  </div> <hr>';
				// echo " <form method='post' action='webseries.php' enctype='multipart/form-data' style='color: red;'>
				// 		 <input type='file' name='file' />
				// 		 <input type='text' name='vname' placeholder='enter webseries name'>
				...
				while ($row = mysqli_fetch_assoc($fetchVideos)) {
					...
					echo '<a href="videos.php?vname=' . $vname . '&season='.$season.'">     
						<div class="card-body col" >
						 ...
						 <a href="videos.php?vname=' . $vname . '&season='.$season.'" class="btn btn-warning" style="width:100%;">GO to Episodes</a>
				...
				<div class="modal-body">
					<form action="webseries.php" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="number" class="form-control" id="inputepisode" aria-describedby="emailHelp" placeholder=" Tolal no. of episodes" name="episode">
						</div>
						...
						<div class="form-group">
							<label for="exampleFormControlFile1">Webseries Image  input</label>
							<input type="file" name="file">
