<div class="nav-bar w-nav" id="nav" data-animation="default" data-collapse="medium" data-contain="1" data-duration="400">
        <div class="w-container">   
            <a class="brand-link w-nav-brand w--current" class="c" href="index.php">
                <img class="logo" src="img/logo1.png" style="width: 5%;"> &nbsp; 
                
              <h4 style="display: inline; color:white;">WEBSERIES</h4>
            ...
            <nav class="nav-menu w-nav-menu" role="navigation" style="transform: translateY(0px) translateX(0px);">
                ...
                {
                    echo'<a class="nav-link w-nav-link" href="webseries.php">WEB Series </a>';
                         echo '<a class="nav-link w-nav-link" href="signout.php">Sign Out  ('.$_SESSION['name']. ')</a>'; 
                    }
                    else{
                    echo '<a class="nav-link w-nav-link" href="login.php">Sign In</a>';
                    }
                ?>
